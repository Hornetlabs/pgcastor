...
#else
#define MZ_MALLOC(x)     rmalloc0(x)
#define MZ_FREE(x)       rfree(x)
#define MZ_REALLOC(p, x) rrealloc0(p, x)
#endif

#define MZ_MAX(a, b)      (((a) > (b)) ? (a) : (b))
#define MZ_MIN(a, b)      (((a) < (b)) ? (a) : (b))
#define MZ_CLEAR_OBJ(obj) rmemset1(&(obj), 0, 0, sizeof(obj))
#define MZ_CLEAR_ARR(obj) rmemset1((obj), 0, 0, sizeof(obj))
#define MZ_CLEAR_PTR(obj) rmemset1((obj), 0, 0, sizeof(*obj))
...
extern "C"
{
    ...
    typedef enum
    {
        ...
        MZ_ZIP_FLAG_VALIDATE_HEADERS_ONLY = 0x2000, /* validate the local headers, but don't decompress the entire file
                                                       and check the crc32 */
        MZ_ZIP_FLAG_WRITE_ZIP64 = 0x4000, /* always use the zip64 file format, instead of the original zip file format
