 ...
 *
 * hash_search.h
 *      exported definitions for src/utils/hash/hash_func.c
 *
 *
 ...
 * used directly.)
 */
typedef void* (*HashCopyFunc)(void* dest, uint64 offset, const void* src, Size keysize, bool heap);
...
extern void*  hash_search_with_hash_value(HTAB* hashp, const void* keyPtr, uint32 hashvalue,
