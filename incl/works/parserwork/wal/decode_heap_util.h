...
extern pg_parser_sysdicts* heap_get_sysdict_by_oid(void* decodingctx, txn* txn, Oid oid, bool search_his);
...
extern void heap_parser2sql(void* decodingctx, txn* txn, pg_parser_translog_tbcolbase* trans_return, Oid oid);

void heap_parser_count_size(void* decodingctx, txn* txn, pg_parser_translog_tbcolbase* trans_return, Oid oid);
...
extern List* decode_heap_multi_insert_save_sysdict_as_insert(List* sysdict, pg_parser_translog_tbcolbase* trans_return);
