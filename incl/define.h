...
typedef enum PGCASTORSTAT
{
    PGCASTORSTAT_INIT = 0x00,
    PGCASTORSTAT_REWIND = 0x01,
    PGCASTORSTAT_REWINDING = 0x02,
    PGCASTORSTAT_RUNNING = 0x03,
    PGCASTORSTAT_SHUTDOWN = 0x04,
    PGCASTORSTAT_RECOVERY = 0x05,
} pgcastorstat;
