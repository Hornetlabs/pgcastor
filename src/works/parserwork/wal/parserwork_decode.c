...
typedef void (*decode_prefunc)(decodingcontext* decodingctx, xk_pg_parser_translog_pre_base* pbase);
...
static decode_premgr m_decodepremgr[] =
{
    ...
    { XK_PG_PARSER_TRANSLOG_HEAP_INSERT,           "INSERT"         , decode_heap },
    { XK_PG_PARSER_TRANSLOG_HEAP_UPDATE,           "UPDATE"         , decode_heap },
    { XK_PG_PARSER_TRANSLOG_HEAP_HOT_UPDATE,       "HOT UPDATE"     , decode_heap },
    { XK_PG_PARSER_TRANSLOG_HEAP_DELETE,           "DELETE"         , decode_heap },
    { XK_PG_PARSER_TRANSLOG_HEAP2_MULTI_INSERT,    "MULTI INSERT"   , decode_heap },
    { XK_PG_PARSER_TRANSLOG_XACT_COMMIT,           "COMMIT"         , decode_xact_commit },
    { XK_PG_PARSER_TRANSLOG_XACT_ABORT,            "ABORT"          , decode_xact_abort },
    ...
    { XK_PG_PARSER_TRANSLOG_XLOG_RECOVERY,         "RECOVERY"       , decode_recovery },
    ...
    { XK_PG_PARSER_TRANSLOG_HEAP_TRUNCATE,         "TRUNCATE"       , heap_truncate },
    {XK_PG_PARSER_TRANSLOG_SEQ,                    "SEQUENCE"       , decode_seq }
};
