...
ripple_catalogdata* ripple_authid_colvalue2authid_hg902(void* in_colvalue)
{
    ...
    /* oid 16 */
    sscanf((char*)((colvalue + 16)->m_value), "%u", &pgauthid->oid);
    authidvalue->oid = pgauthid->oid;

    /* rolbypassrls 7 */
    pgauthid->rolbypassrls = ((char*)((colvalue + 7)->m_value))[0] == 't' ? true : false;

    /* rolcanlogin 5 */
    pgauthid->rolcanlogin = ((char*)((colvalue + 5)->m_value))[0] == 't' ? true : false;

    /* rolconnlimit 8 */
    sscanf((char*)((colvalue + 8)->m_value), "%d", &pgauthid->rolconnlimit);

    /* rolcreatedb 4 */
    pgauthid->rolcreatedb = ((char*)((colvalue + 4)->m_value))[0] == 't' ? true : false;

    /* rolcreaterole 3 */
    pgauthid->rolcreaterole = ((char*)((colvalue + 3)->m_value))[0] == 't' ? true : false;

    /* rolinherit 2 */
    pgauthid->rolinherit = ((char*)((colvalue + 2)->m_value))[0] == 't' ? true : false;

    /* rolname 0 */
    rmemcpy1(pgauthid->rolname.data, 0, (char*)((colvalue + 0)->m_value), (colvalue + 0)->m_valueLen);

    /* rolreplication 6 */
    pgauthid->rolreplication = ((char*)((colvalue + 6)->m_value))[0] == 't' ? true : false;

    /* rolsuper 1 */
    pgauthid->rolsuper = ((char*)((colvalue + 1)->m_value))[0] == 't' ? true : false;
