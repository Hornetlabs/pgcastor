...
ripple_catalogdata* ripple_class_colvalue2class_hg902(void* in_colvalue)
{
    ...
    /* oid  32*/
    sscanf((char*)((colvalue + 32)->m_value), "%u", &pgclass->oid);
    classvalue->oid = pgclass->oid;

    /* relfilenode 6 */
    sscanf((char*)((colvalue + 6)->m_value), "%u", &pgclass->relfilenode);

    /* relkind 15 */
    pgclass->relkind = ((char*)((colvalue + 15)->m_value))[0];
    ...
    /* relname 0*/
    rmemcpy0(pgclass->relname.data, 0, (char*)(colvalue->m_value), colvalue->m_valueLen);

    /* relnamespace 1*/
    sscanf((char*)((colvalue + 1)->m_value), "%u", &pgclass->relnamespace);

    /* relnatts 16 */
    sscanf((char*)((colvalue + 16)->m_value), "%hd", &pgclass->relnatts);

    /* relpersistence 14 */
    pgclass->relpersistence = ((char*)((colvalue + 14)->m_value))[0];

    /* relreplident 27 */
    pgclass->relreplident = ((char*)((colvalue + 27)->m_value))[0];

    /* reltablespace 7 */
    sscanf((char*)((colvalue + 7)->m_value), "%u", &pgclass->reltablespace);
    if(0 == pgclass->reltablespace)
    {
        pgclass->reltablespace = RIPPLE_PG_DFAULT_TABLESPACE;
    }
    ...
    /* reltoastrelid 11 */
    sscanf((char*)((colvalue + 11)->m_value), "%u", &pgclass->reltoastrelid);

    /* reltype 2 */
    sscanf((char*)((colvalue + 2)->m_value), "%u", &pgclass->reltype);
...
ripple_catalogdata* ripple_class_colvalue2class_nofilter_hg902(void* in_colvalue)
{
   ...
   /* relfilenode 6 */
    ...
    /* relname 0*/
    rmemcpy1(pgclass->relname.data, 0, (char*)(colvalue->m_value), colvalue->m_valueLen);
