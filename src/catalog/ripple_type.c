...
ripple_catalogdata* ripple_type_colvalue2type_hg902(void* in_colvalue)
{
    ...
    /* oid 30 */
    sscanf((char*)((colvalue + 30)->m_value), "%u", &pgtype->oid);
    typevalue->oid = pgtype->oid;

    /* typalign 20 */
    pgtype->typalign = ((char*)((colvalue + 20)->m_value))[0];

    /* typbyval 4 */
    pgtype->typbyval = ((char*)((colvalue + 4)->m_value))[0] == 't' ? true : false;

    /* typdelim 9 */
    pgtype->typdelim = ((char*)((colvalue + 9)->m_value))[0];

    /* typelem 11 */
    sscanf((char*)((colvalue + 11)->m_value), "%u", &pgtype->typelem);

    /* typlen 3 */
    sscanf((char*)((colvalue + 3)->m_value), "%hd", &pgtype->typlen);

    /* typname 0 */
    rmemcpy1(pgtype->typname.data, 0, (char*)((colvalue + 0)->m_value), (colvalue + 0)->m_valueLen);

    /* typoutput 14 */
    sscanf((char*)((colvalue + 14)->m_value), "%u", &pgtype->typoutput);

    /* typrelid 10 */
    sscanf((char*)((colvalue + 10)->m_value), "%u", &pgtype->typrelid);

    /* typstorage 21 */
    pgtype->typstorage = ((char*)((colvalue + 21)->m_value))[0];

    /* typtype 5 */
    pgtype->typtype = ((char*)((colvalue + 5)->m_value))[0];
