...
static void ripple_parsertrail_txndelete2hash(ripple_parsertrail* parsertrail,
...
/* 将表数据加入到事务缓存中 */
bool ripple_parsertrail_txndeleteapply(ripple_parsertrail* parsertrail,
                                                void* data)
{
    ...
    /* 将数据放入到缓存当中 */
    ripple_parsertrail_txndelete2hash(parsertrail, txndata);
