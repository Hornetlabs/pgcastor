...
/*---------------------pump 配置项 begin---------------------------*/
static ripple_pump_cfg                 g_pumpcfg = { 0 };

static struct config_int ConfigureNamesIntPump[] =
{
    {
        {RIPPLE_CFG_KEY_TRAIL_MAX_SIZE, PGC_INTERNAL,
            gettext_noop("trail file max size, unit MB"),
    ...
    },
    {
        ...
        &(g_pumpcfg.tcp_keepalives_interval),
        5, 0, 300,
        NULL, NULL
    },
    {
        ...
        &(g_pumpcfg.tcp_keepalives_count),
        10, 0, 100,
        NULL, NULL
    },
    {
...
static struct config_string ConfigureNamesStringPump[] =
{
    {
        {RIPPLE_CFG_KEY_LOG_LEVEL, PGC_INTERNAL,
            gettext_noop("log level, DEBUG INFO WARNING ERROR"),
    ...
    {
        {RIPPLE_CFG_KEY_DBNAME, PGC_INTERNAL,
            gettext_noop("The database name that needs to be synchronized"),
            NULL
        },
        &(g_pumpcfg.dbname),
        "postgres",
    ...
    {
        {RIPPLE_CFG_KEY_FTPURL, PGC_INTERNAL,
            gettext_noop("ftp url"),
            NULL
        },
        &(g_pumpcfg.ftpurl),
        NULL,
    ...
    {
        {RIPPLE_CFG_KEY_FTPDATA, PGC_INTERNAL,
            gettext_noop("ftp data"),
            NULL
        },
        &(g_pumpcfg.ftpdata),
        NULL,
    ...
    {
        {RIPPLE_CFG_KEY_FTPSSL, PGC_INTERNAL,
            gettext_noop("enable SSL verification"),
            NULL
        },
        &(g_pumpcfg.ssl),
        "off",
...
/*---------------------collector 配置项 begin---------------------------*/
static ripple_collector_cfg             g_collectorcfg = { 0 };

static struct config_int ConfigureNamesIntCollector[] =
{
    {
        {RIPPLE_CFG_KEY_TRAIL_MAX_SIZE, PGC_INTERNAL,
            gettext_noop("trail file max size, unit MB"),
    ...
    },
    {
        ...
        &(g_collectorcfg.tcp_user_timeout),
        60000, 0, 300000,
        NULL, NULL
    },
    {
        ...
        &(g_collectorcfg.tcp_keepalives_idle),
        30, 0, 300,
        NULL, NULL
    },
    {
        ...
        &(g_collectorcfg.tcp_keepalives_interval),
        5, 0, 300,
        NULL, NULL
    },
    {
        ...
        &(g_collectorcfg.tcp_keepalives_count),
        10, 0, 100,
        NULL, NULL
    },
    {
...
static struct config_string ConfigureNamesStringCollector[] =
{
    {
        {RIPPLE_CFG_KEY_LOG_LEVEL, PGC_INTERNAL,
            gettext_noop("log level, DEBUG INFO WARNING ERROR"),
...
/*---------------------fastcompare 配置项 begin-------------------------*/
static ripple_tools_fastcmpcorr_cfg         m_toolsfastcmpcorrcfg = { 0 };

static struct config_int ConfigureNamesIntFastCmpCorrect[] =
{
    {
        {RIPPLE_CFG_KEY_PORT, PGC_INTERNAL,
            gettext_noop("target host listen port"),
    ...
    },
    {
        ...
        &(m_toolsfastcmpcorrcfg.tcp_keepalive),
        1, 0, 1,
        NULL, NULL
    },
    {
        ...
        &(m_toolsfastcmpcorrcfg.tcp_user_timeout),
        60000, 0, 300000,
        NULL, NULL
    },
    {
        ...
        &(m_toolsfastcmpcorrcfg.tcp_keepalives_idle),
        30, 0, 300,
        NULL, NULL
    },
    {
        ...
        &(m_toolsfastcmpcorrcfg.tcp_keepalives_interval),
        5, 0, 300,
        NULL, NULL
    },
    {
        ...
        &(m_toolsfastcmpcorrcfg.tcp_keepalives_count),
        10, 0, 100,
        NULL, NULL
    },
    /* End-of-list marker */
...
static struct config_string ConfigureNamesStringFastCmpCorrect[] =
{
    {
        {RIPPLE_CFG_KEY_LOG_LEVEL, PGC_INTERNAL,
            gettext_noop("log level, DEBUG INFO WARNING ERROR"),
        ...
        &(m_toolsfastcmpcorrcfg.szloglevel),
        "INFO",
        NULL, NULL
    },
    {
...
static ripple_tools_fastcmpclient_cfg         m_toolsfastcmpclientcfg = { 0 };

static struct config_int ConfigureNamesIntFastCmpClient[] =
{
    {
        {RIPPLE_CFG_KEY_PORT, PGC_INTERNAL,
            gettext_noop("target host listen port"),
    ...
    },
    {
        ...
        &(m_toolsfastcmpclientcfg.tcp_keepalive),
        1, 0, 1,
        NULL, NULL
    },
    {
        ...
        &(m_toolsfastcmpclientcfg.tcp_user_timeout),
        60000, 0, 300000,
        NULL, NULL
    },
    {
        ...
        &(m_toolsfastcmpclientcfg.tcp_keepalives_idle),
        30, 0, 300,
        NULL, NULL
    },
    {
        ...
        &(m_toolsfastcmpclientcfg.tcp_keepalives_interval),
        5, 0, 300,
        NULL, NULL
    },
    {
        ...
        &(m_toolsfastcmpclientcfg.tcp_keepalives_count),
        10, 0, 100,
        NULL, NULL
    },
    {
        {RIPPLE_CFG_KEY_FASTCMP_MAX_PARALLEL_WORKS, PGC_INTERNAL,
            gettext_noop("max parallel works"),
            NULL
        },
        &(m_toolsfastcmpclientcfg.max_parallel_works),
        4, 1, 100,
        NULL, NULL
    },
    {
        {RIPPLE_CFG_KEY_FASTCMP_MAXMEMARY, PGC_INTERNAL,
            gettext_noop("max memory"),
            NULL
        },
        &(m_toolsfastcmpclientcfg.max_mem),
        1024, 16, 32768,
        NULL, NULL
    },
    /* End-of-list marker */
...
static struct config_string ConfigureNamesStringFastCmpClient[] =
{
    {
        {RIPPLE_CFG_KEY_LOG_LEVEL, PGC_INTERNAL,
            gettext_noop("log level, DEBUG INFO WARNING ERROR"),
        ...
        &(m_toolsfastcmpclientcfg.szloglevel),
        "INFO",
        NULL, NULL
    },
    {
...
static void guc_pumpdebug(void)
{
    ListCell* lc = NULL;
    List* ls = NULL;
    printf("---------pump config begin--------------\n");
    printf("szloglevel:     %s\n", g_pumpcfg.szloglevel == NULL ? "NULL" : g_pumpcfg.szloglevel);
    printf("data:           %s\n", g_pumpcfg.data == NULL ? "NULL" : g_pumpcfg.data);
    printf("traildir:       %s\n", g_pumpcfg.traildir == NULL ? "NULL" : g_pumpcfg.traildir);
    printf("host:           %s\n", g_pumpcfg.host == NULL ? "NULL" : g_pumpcfg.host);
    printf("port:           %d\n", g_pumpcfg.port);
    ...
    printf("---------pump config   end--------------\n");
}


static void guc_collectordebug(void)
{
    printf("---------collector config begin--------------\n");
    printf("szloglevel:     %s\n", g_collectorcfg.szloglevel == NULL ? "NULL" : g_collectorcfg.szloglevel);
    printf("data:           %s\n", g_collectorcfg.data == NULL ? "NULL" : g_collectorcfg.data);
    printf("host:           %s\n", g_collectorcfg.host == NULL ? "NULL" : g_collectorcfg.host);
    printf("port:           %d\n", g_collectorcfg.port);
    printf("---------collector config   end--------------\n");
}
...
static void guc_fastcmpclientdebug(void)
{
    printf("---------fast compare client config begin--------------\n");
    printf("szloglevel:     %s\n",
            m_toolsfastcmpclientcfg.szloglevel == NULL ? "NULL" : m_toolsfastcmpclientcfg.szloglevel);
    printf("url:            %s\n",
            m_toolsfastcmpclientcfg.url == NULL ? "NULL" : m_toolsfastcmpclientcfg.url);
    printf("host:            %s\n",
            m_toolsfastcmpclientcfg.host == NULL ? "NULL" : m_toolsfastcmpclientcfg.host);
    printf("port:            %d\n",
            m_toolsfastcmpclientcfg.port);
    
    printf("---------fast compare client config   end--------------\n");
}

static void guc_fastcmpserverdebug(void)
{
    printf("---------fast compare server config begin--------------\n");
    printf("szloglevel:     %s\n",
            m_toolsfastcmpcorrcfg.szloglevel == NULL ? "NULL" : m_toolsfastcmpcorrcfg.szloglevel);
    printf("url:            %s\n",
            m_toolsfastcmpcorrcfg.url == NULL ? "NULL" : m_toolsfastcmpcorrcfg.url);
    printf("host:            %s\n",
            m_toolsfastcmpcorrcfg.host == NULL ? "NULL" : m_toolsfastcmpcorrcfg.host);
    printf("port:            %d\n",
            m_toolsfastcmpcorrcfg.port);
    
    printf("---------fast compare server config   end--------------\n");
}
...
static ripple_guc_cfg m_guccfg[] =
{
    ...
    },
    {
        ...
        ConfigureNamesIntPump,
        ConfigureNamesStringPump,
        guc_pumpdebug
    },
    {
        RIPPLE_PROC_TYPE_COLLECTOR,
        ConfigureNamesIntCollector,
        ConfigureNamesStringCollector,
        guc_collectordebug
    },
    {
    ...
    },
    {
        ...
        ConfigureNamesIntFastCmpClient,
        ConfigureNamesStringFastCmpClient,
        guc_fastcmpclientdebug
    },
    {
        RIPPLE_PROC_TYPE_FASTCMPSVR,
        ConfigureNamesIntFastCmpCorrect,
        ConfigureNamesStringFastCmpCorrect,
        guc_fastcmpserverdebug
    },
    {
...
char* guc_getdata(void)
{
    switch (g_proctype)
    {
        ...
        case RIPPLE_PROC_TYPE_PUMP:
            return g_pumpcfg.data;
        case RIPPLE_PROC_TYPE_COLLECTOR:
            return g_collectorcfg.data;
