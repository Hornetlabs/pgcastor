...
static int set_config_option(const char* name, const char* value, bool reload)
{
...
static void guc_loadcfgInternal(const char* in_cfg, bool reload)
{
    int             i = 0;
    ConfigVariable* item = NULL;
