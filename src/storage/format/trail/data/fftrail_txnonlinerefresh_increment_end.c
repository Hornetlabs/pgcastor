...
bool fftrail_txnonlinerefresh_increment_end_serial(void* data, void* state)
{
    /*
     * Record format:
     *  GroupToken
    ...
    txndata->header.subtype = FF_DATA_TYPE_ONLINE_REFRESH_INCREMENT_END;
...
bool fftrail_txnonlinerefresh_increment_end_deserial(void** data, void* state)
{
    ...
    *data = txndata;
    ...
    rstmt->type = TXNSTMT_TYPE_ONLINEREFRESH_INCREMENT_END;
