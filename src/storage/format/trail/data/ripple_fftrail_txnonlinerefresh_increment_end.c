...
bool ripple_fftrail_txnonlinerefresh_increment_end_serial(void* data, void* state)
{
    /*
     * Record格式为:
     *  GroupToken
    ...
    txndata->header.subtype = RIPPLE_FF_DATA_TYPE_ONLINE_REFRESH_INCREMENT_END;
...
bool ripple_fftrail_txnonlinerefresh_increment_end_deserial(void** data, void* state)
{
    ...
    *data = txndata;
    ...
    rstmt->type = RIPPLE_TXNSTMT_TYPE_ONLINEREFRESH_INCREMENT_END;
