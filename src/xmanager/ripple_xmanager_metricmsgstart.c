 ...
 *  4、执行初始化命令
*/
bool ripple_xmanager_metricmsg_parsestart(ripple_xmanager_metric* xmetric,
                                          ...
                                          ripple_netpacket* npacket)
{
    ...
    if (RIPPLE_XMANAGER_METRICNODETYPE_PROCESS <= jobtype)
    {
        ...
        goto ripple_xmanager_metricmsg_parsestart_error;
    }
    ...
    asyncmsg->msgtype = RIPPLE_XMANAGER_MSG_STARTCMD;
    ...
    {
        errcode = RIPPLE_ERROR_MSGCOMMAND;
        snprintf(errormsg, 2048, "ERROR: can not start %s", ripple_xmanager_metricnode_getname(jobtype));
...
ripple_xmanager_metricmsg_parsestart_error:
 ...
 * 组装 start 返回消息
*/
bool ripple_xmanager_metricmsg_assemblestart(ripple_xmanager_metric* xmetric,
                                             ripple_netpoolentry* npoolentry,
                                             dlist* dlmsgs)
{
    uint8 u8value                                       = 0;
