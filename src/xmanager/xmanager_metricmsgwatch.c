 ...
 */
bool xmanager_metricmsg_parsewatch(xmanager_metric* xmetric, netpoolentry* npoolentry, netpacket* npacket)
{
    /* Error code */
    int                  errcode = 0;
    int                  len = 0;
...
xmanager_metricmsg_parsewatch_error:
    ...
    return xmanager_metricmsg_assembleerrormsg(xmetric, npoolentry->wpackets, XMANAGER_MSG_WATCHCMD, errcode, errormsg);
}
