...
static txnstmtops m_txnstmtsops[] = {
    ...
    {TXNSTMT_TYPE_ONLINEREFRESH_BEGIN,         "ONLINEREFRESH BEGIN STMT",   txnstmt_onlinerefresh_begin_free        },
    ...
    {TXNSTMT_TYPE_ONLINEREFRESH_INCREMENT_END,
     "ONLINEREFRESH INCREMENT END STMT",                                     txnstmt_onlinerefresh_increment_end_free},
    {TXNSTMT_TYPE_ONLINEREFRESH_DATASET,       "ONLINEREFRESH DATASET STMT", txnstmt_onlinerefresh_dataset_free      },
