...
extern bool pg_parser_sysdict_getTableInfo(uint32_t record_relfilenode, pg_parser_sysdicts* sysdict,
                                           pg_parser_sysdict_tableInfo* tbinfo);

extern bool pg_parser_sysdict_getTypeInfo(uint32_t oid, pg_parser_sysdicts* sysdict,
...
extern bool pg_parser_sysdict_getProcInfoByOid(uint32_t oid, pg_parser_sysdicts* sysdict,
                                               char** proname, char** nspname);

extern bool     pg_parser_sysdict_getEnumNameByOid(uint32_t oid, pg_parser_sysdicts* sysdict,
                                                   char** enumname);
