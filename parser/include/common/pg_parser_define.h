...
#define PG_PARSER_VARTAG_IS_EXPANDED(tag) \
    (((tag) & ~1) == PG_PARSER_VARTAG_EXPANDED_RO)
...
#define PG_PARSER_VARTAG_1B_E(PTR) \
    (((pg_parser_varattrib_1b_e *) (PTR))->va_tag)

#define PG_PARSER_VARATT_IS_1B_E(PTR) \
    ((((pg_parser_varattrib_1b *) (PTR))->va_header) == 0x01)
#define PG_PARSER_VARATT_IS_1B(PTR) \
    ((((pg_parser_varattrib_1b *) (PTR))->va_header & 0x01) == 0x01)
#define PG_PARSER_VARATT_IS_4B_U(PTR) \
	((((pg_parser_varattrib_1b *) (PTR))->va_header & 0x03) == 0x00)

#define PG_PARSER_VARSIZE_1B(PTR) \
    ((((pg_parser_varattrib_1b *) (PTR))->va_header >> 1) & 0x7F)
#define PG_PARSER_VARSIZE_4B(PTR) \
    ((((pg_parser_varattrib_4b *) (PTR))->va_4byte.va_header >> 2) & 0x3FFFFFFF)

#define PG_PARSER_VARATT_IS_4B_C(PTR) \
    ((((pg_parser_varattrib_1b *) (PTR))->va_header & 0x03) == 0x02)
...
#define PG_PARSER_VARSIZE_EXTERNAL(PTR)   (PG_PARSER_VARHDRSZ_EXTERNAL + PG_PARSER_VARTAG_SIZE(PG_PARSER_VARTAG_EXTERNAL(PTR)))

#define PG_PARSER_VARSIZE_ANY(PTR) \
    (PG_PARSER_VARATT_IS_1B_E(PTR) ? PG_PARSER_VARSIZE_EXTERNAL(PTR) : \
     (PG_PARSER_VARATT_IS_1B(PTR) ? PG_PARSER_VARSIZE_1B(PTR) : \
      PG_PARSER_VARSIZE_4B(PTR)))
...
#define PG_PARSER_VARSIZE_ANY_EXHDR(PTR) \
    (PG_PARSER_VARATT_IS_1B_E(PTR) ? PG_PARSER_VARSIZE_EXTERNAL(PTR)-PG_PARSER_VARHDRSZ_EXTERNAL : \
...
#define PG_PARSER_VARATT_IS_EXTERNAL_ONDISK(PTR) \
    ...
    && PG_PARSER_VARTAG_EXTERNAL(PTR) == PG_PARSER_VARTAG_ONDISK)
...
#define PG_PARSER_TOAST_COMPRESS_RAWSIZE(ptr) \
    (((pg_parser_toast_compress_header *) (ptr))->rawsize)
#define PG_PARSER_TOAST_COMPRESS_RAWDATA(ptr) \
    (((char *) (ptr)) + PG_PARSER_TOAST_COMPRESS_HDRSZ)
...
#define PG_PARSER_PG14_VARHDRSZ_COMPRESSED offsetof(pg_parser_pg14_varattrib_4b, va_compressed.va_data)
...
#define PG_PARSER_PG14_VARDATA_COMPRESSED_GET_EXTSIZE(PTR) \
    (((pg_parser_pg14_varattrib_4b *) (PTR))->va_compressed.va_tcinfo & PG_PARSER_PG14_VARLENA_EXTSIZE_MASK)
#define PG_PARSER_PG14_VARDATA_COMPRESSED_GET_COMPRESS_METHOD(PTR) \
    (((pg_parser_pg14_varattrib_4b *) (PTR))->va_compressed.va_tcinfo >> PG_PARSER_PG14_VARLENA_EXTSIZE_BITS)
