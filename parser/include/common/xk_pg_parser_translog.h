...
typedef enum XK_PG_PARSER_DATABASE_TYPE
{
    ...
    XK_DATABASE_TYPE_ORACLE,
    XK_DATABASE_TYPE_POSTGRESQL,
    XK_DATABASE_TYPE_GAUSS,
    XK_DATABASE_TYPE_SQLSERVER,
    XK_DATABASE_TYPE_VASTBASE,
    XK_DATABASE_TYPE_MOGDB,
    XK_DATABASE_TYPE_HGDB,
    XK_DATABASE_TYPE_KINGBASE,
    XK_DATABASE_TYPE_UXDB
} xk_pg_parser_database_type;

#define XK_DATABASE_HGDBV457 "v457"
#define XK_DATABASE_HGDBV458 "v458"
#define XK_DATABASE_HGDBV9PG "v9pg"
#define XK_DATABASE_HGDBV901 "v901"

#define XK_DATABASE_PG127    "pg127"
#define XK_DATABASE_PG1410   "pg1410"

#define XK_DATABASE_KINGBASEV9 "v9"
#define XK_DATABASE_KINGBASEV8 "v8"
