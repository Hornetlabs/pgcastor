...
extern bool pg_parser_trans_transrec_decodeXlogRecord(
    ...
    uint32_t BLCKSZ, int32_t* pg_parser_errno, bool is_pre_parsing, int16_t dbtype,
    char* dbversion);

extern char* pg_parser_XLogRecGetBlockData(pg_parser_trans_transrec_decode_XLogReaderState* record,
