...
extern pg_parser_translog_ddlstmt* pg_parser_ddl_firstTransDDL(pg_parser_translog_systb2ddl*        pg_parser_ddl,
...
/* DDL parse function */
extern pg_parser_translog_ddlstmt* pg_parser_DDL_truncate(pg_parser_translog_systb2ddl*        pg_parser_ddl,
                                                          pg_parser_translog_systb2dll_record* current_record,
                                                          pg_parser_ddlstate*                  ddlstate,
                                                          int32_t*                             pg_parser_errno);
...
extern pg_parser_translog_ddlstmt* pg_parser_DDL_create_schema(pg_parser_translog_systb2ddl*        pg_parser_ddl,
                                                               pg_parser_translog_systb2dll_record* current_record,
                                                               pg_parser_ddlstate*                  ddlstate,
                                                               int32_t*                             pg_parser_errno);

extern pg_parser_translog_ddlstmt* pg_parser_DDL_drop_schema(pg_parser_translog_systb2ddl*        pg_parser_ddl,
                                                             pg_parser_translog_systb2dll_record* current_record,
                                                             pg_parser_ddlstate*                  ddlstate,
                                                             int32_t*                             pg_parser_errno);
...
extern pg_parser_translog_ddlstmt* pg_parser_DDL_create_database(pg_parser_translog_systb2ddl*        pg_parser_ddl,
                                                                 pg_parser_translog_systb2dll_record* current_record,
                                                                 pg_parser_ddlstate*                  ddlstate,
                                                                 int32_t*                             pg_parser_errno);

extern pg_parser_translog_ddlstmt* pg_parser_DDL_drop_database(pg_parser_translog_systb2ddl*        pg_parser_ddl,
                                                               pg_parser_translog_systb2dll_record* current_record,
                                                               pg_parser_ddlstate*                  ddlstate,
                                                               int32_t*                             pg_parser_errno);

extern pg_parser_translog_ddlstmt* pg_parser_DDL_create_type(pg_parser_translog_systb2ddl*        pg_parser_ddl,
                                                             pg_parser_translog_systb2dll_record* current_record,
                                                             pg_parser_ddlstate*                  ddlstate,
                                                             int32_t*                             pg_parser_errno);

extern pg_parser_translog_ddlstmt* pg_parser_DDL_drop_type(pg_parser_translog_systb2ddl*        pg_parser_ddl,
                                                           pg_parser_translog_systb2dll_record* current_record,
                                                           pg_parser_ddlstate*                  ddlstate,
                                                           int32_t*                             pg_parser_errno);

extern pg_parser_translog_ddlstmt* pg_parser_DDL_create_table(pg_parser_translog_systb2ddl*        pg_parser_ddl,
                                                              pg_parser_translog_systb2dll_record* current_record,
                                                              pg_parser_ddlstate*                  ddlstate,
                                                              int32_t*                             pg_parser_errno);

extern pg_parser_translog_ddlstmt* pg_parser_DDL_create_view(pg_parser_translog_systb2ddl*        pg_parser_ddl,
                                                             pg_parser_translog_systb2dll_record* current_record,
                                                             pg_parser_ddlstate*                  ddlstate,
                                                             int32_t*                             pg_parser_errno);

extern pg_parser_translog_ddlstmt* pg_parser_DDL_drop_view(pg_parser_translog_systb2ddl*        pg_parser_ddl,
                                                           pg_parser_translog_systb2dll_record* current_record,
                                                           pg_parser_ddlstate*                  ddlstate,
                                                           int32_t*                             pg_parser_errno);

extern pg_parser_translog_ddlstmt* pg_parser_DDL_drop_table(pg_parser_translog_systb2ddl*        pg_parser_ddl,
                                                            pg_parser_translog_systb2dll_record* current_record,
                                                            pg_parser_ddlstate*                  ddlstate,
                                                            int32_t*                             pg_parser_errno);
...
extern pg_parser_translog_ddlstmt* pg_parser_DDL_create_index(pg_parser_translog_systb2ddl*        pg_parser_ddl,
                                                              pg_parser_translog_systb2dll_record* current_record,
                                                              pg_parser_ddlstate*                  ddlstate,
                                                              int32_t*                             pg_parser_errno);
...
extern pg_parser_translog_ddlstmt* pg_parser_DDL_drop_index(pg_parser_translog_systb2ddl*        pg_parser_ddl,
                                                            pg_parser_translog_systb2dll_record* current_record,
                                                            pg_parser_ddlstate*                  ddlstate,
                                                            int32_t*                             pg_parser_errno);
...
extern pg_parser_translog_ddlstmt* pg_parser_DDL_create_sequence(pg_parser_translog_systb2ddl*        pg_parser_ddl,
                                                                 pg_parser_translog_systb2dll_record* current_record,
                                                                 pg_parser_ddlstate*                  ddlstate,
                                                                 int32_t*                             pg_parser_errno);

extern pg_parser_translog_ddlstmt* pg_parser_DDL_drop_sequence(pg_parser_translog_systb2ddl*        pg_parser_ddl,
                                                               pg_parser_translog_systb2dll_record* current_record,
                                                               pg_parser_ddlstate*                  ddlstate,
                                                               int32_t*                             pg_parser_errno);
...
extern pg_parser_translog_ddlstmt* pg_parser_DDL_reindex(pg_parser_translog_systb2ddl*        pg_parser_ddl,
                                                         pg_parser_translog_systb2dll_record* current_record,
                                                         pg_parser_ddlstate*                  ddlstate,
                                                         int32_t*                             pg_parser_errno);
