...
pg_parser_Datum enum_out(pg_parser_Datum attr, pg_parser_extraTypoutInfo* info)
{
 ...
 */
pg_parser_Datum anyenum_out(pg_parser_Datum attr, pg_parser_extraTypoutInfo* info)
{
