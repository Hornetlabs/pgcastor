...
pg_parser_Datum path_out(pg_parser_Datum attr, pg_parser_extraTypoutInfo* info)
{
    bool  is_toast = false;
 ...
 *---------------------------------------------------------------*/
pg_parser_Datum poly_out(pg_parser_Datum attr, pg_parser_extraTypoutInfo* info)
{
    bool     is_toast = false;
    bool     need_free = false;
    char*    result = NULL;
