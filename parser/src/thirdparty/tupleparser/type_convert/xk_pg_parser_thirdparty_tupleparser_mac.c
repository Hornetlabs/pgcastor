/**
 * @file xk_pg_parser_thirdparty_tupleparser_mac.c
 * @author bytesync
 * @brief 
 * @version 0.1
 * @date 2023-08-03
...
xk_pg_parser_Datum macaddr_out(xk_pg_parser_Datum attr)
{
    macaddr    *addr = (macaddr *) attr;
    char       *result = NULL;

    if (!xk_pg_parser_mcxt_malloc(PGFUNC_MAC_MCXT, (void **) &result, 32))
...
xk_pg_parser_Datum macaddr8_out(xk_pg_parser_Datum attr)
{
