...
char* XK_PG_US_Central[] =
{
    ...
    (char *)"Rule	Chicago	1920	only	-	Jun	13	2:00	1:00	D",
    (char *)"Rule	Chicago	1920	1921	-	Oct	lastSun	2:00	0	S",
    (char *)"Rule	Chicago	1921	only	-	Mar	lastSun	2:00	1:00	D",
    (char *)"Rule	Chicago	1922	1966	-	Apr	lastSun	2:00	1:00	D",
    (char *)"Rule	Chicago	1922	1954	-	Sep	lastSun	2:00	0	S",
    (char *)"Rule	Chicago	1955	1966	-	Oct	lastSun	2:00	0	S",
    (char *)"Zone America/Chicago	-5:50:36 -	LMT	1883 Nov 18 12:09:24",
    (char *)"			-6:00	US	C%sT	1920",
    (char *)"			-6:00	Chicago	C%sT	1936 Mar  1  2:00",
    (char *)"			-5:00	-	EST	1936 Nov 15  2:00",
    (char *)"			-6:00	Chicago	C%sT	1942",
    (char *)"			-6:00	US	C%sT	1946",
    (char *)"			-6:00	Chicago	C%sT	1967",
    (char *)"			-6:00	US	C%sT",
    (char *)"Link	America/Chicago		US/Central"
};
