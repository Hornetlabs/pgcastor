...
char* XK_PG_US_Michigan[] =
{
    ...
    (char *)"Rule	Detroit	1948	only	-	Apr	lastSun	2:00	1:00	D",
    (char *)"Rule	Detroit	1948	only	-	Sep	lastSun	2:00	0	S",
    (char *)"Zone America/Detroit	-5:32:11 -	LMT	1905",
    (char *)"			-6:00	-	CST	1915 May 15  2:00",
    (char *)"			-5:00	-	EST	1942",
    (char *)"			-5:00	US	E%sT	1946",
    (char *)"			-5:00	Detroit	E%sT	1967 Jun 14  0:01",
    (char *)"			-5:00	US	E%sT	1969",
    (char *)"			-5:00	-	EST	1973",
    (char *)"			-5:00	US	E%sT	1975",
    (char *)"			-5:00	-	EST	1975 Apr 27  2:00",
    (char *)"			-5:00	US	E%sT",
    (char *)"Link	America/Detroit		US/Michigan"
};
