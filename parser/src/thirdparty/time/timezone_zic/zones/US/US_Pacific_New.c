...
char* XK_PG_US_Pacific_New[] =
{
    ...
    (char *)"Zone America/Los_Angeles -7:52:58 -	LMT	1883 Nov 18 12:07:02",
    (char *)"			-8:00	US	P%sT	1946",
    (char *)"			-8:00	CA	P%sT	1967",
    (char *)"			-8:00	US	P%sT",
    (char *)"Link	America/Los_Angeles	US/Pacific-New	##"
};
