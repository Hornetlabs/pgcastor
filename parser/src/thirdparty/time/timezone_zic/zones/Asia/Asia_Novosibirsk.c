...
char* PG_Asia_Novosibirsk[] =
{
    ...
    (char *)"Zone Asia/Novosibirsk	 5:31:40 -	LMT	1919 Dec 14  6:00",
    (char *)"			 6:00	-	NOVT	1930 Jun 21 # Novosibirsk Time",
    (char *)"			 7:00	Russia	NOV%sT	1991 Mar 31 2:00s",
    (char *)"			 6:00	Russia	NOV%sT	1992 Jan 19 2:00s",
    (char *)"			 7:00	Russia	NOV%sT	1993 May 23 # say Shanks & P.",
    (char *)"			 6:00	Russia	NOV%sT	2011 Mar 27 2:00s",
    (char *)"			 7:00	-	NOVT	2014 Oct 26  2:00s",
    (char *)"			 6:00	-	NOVT	2016 Jul 24  2:00s",
    (char *)"			 7:00	-	NOVT"
};
