...
char* XK_PG_Asia_Omsk[] =
{
    ...
    (char *)"Zone Asia/Omsk		 4:53:30 -	LMT	1919 Nov 14",
    (char *)"			 5:00	-	OMST	1930 Jun 21 # Omsk TIme",
    (char *)"			 6:00	Russia	OMS%sT	1991 Mar 31 2:00s",
    (char *)"			 5:00	Russia	OMS%sT	1992 Jan 19 2:00s",
    (char *)"			 6:00	Russia	OMS%sT	2011 Mar 27 2:00s",
    (char *)"			 7:00	-	OMST	2014 Oct 26  2:00s",
    (char *)"			 6:00	-	OMST"
};
