...
char* XK_PG_Asia_Krasnoyarsk[] =
{
    ...
    (char *)"Zone Asia/Krasnoyarsk	 6:11:26 -	LMT	1920 Jan  6",
    (char *)"			 6:00	-	KRAT	1930 Jun 21",
    (char *)"			 7:00	Russia	KRA%sT	1991 Mar 31  2:00s",
    (char *)"			 6:00	Russia	KRA%sT	1992 Jan 19  2:00s",
    (char *)"			 7:00	Russia	KRA%sT	2011 Mar 27  2:00s",
    (char *)"			 8:00	-	KRAT	2014 Oct 26  2:00s",
    (char *)"			 7:00	-	KRAT"
};
