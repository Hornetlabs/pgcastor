...
char* XK_PG_Europe_Sarajevo[] =
{
    ...
    (char *)"Zone	Europe/Belgrade	1:22:00	-	LMT	1884",
    (char *)"			1:00	-	CET	1941 Apr 18 23:00",
    (char *)"			1:00	C-Eur	CE%sT	1945",
    (char *)"			1:00	-	CET	1945 May  8  2:00s",
    (char *)"			1:00	1:00	CEST	1945 Sep 16  2:00s",
    (char *)"			1:00	-	CET	1982 Nov 27",
    (char *)"			1:00	EU	CE%sT",
    (char *)"Link Europe/Belgrade Europe/Sarajevo	# Bosnia and Herzegovina"
};
