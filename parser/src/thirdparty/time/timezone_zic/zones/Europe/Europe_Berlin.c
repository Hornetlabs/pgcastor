...
char* XK_PG_Europe_Berlin[] =
{
    ...
    (char *)"Rule	Germany	1946	only	-	Apr	14	2:00s	1:00	S",
    (char *)"Rule	Germany	1946	only	-	Oct	 7	2:00s	0	-",
    (char *)"Rule	Germany	1947	1949	-	Oct	Sun>=1	2:00s	0	-",
    (char *)"Rule	Germany	1947	only	-	Apr	 6	3:00s	1:00	S",
    (char *)"Rule	Germany	1947	only	-	May	11	2:00s	2:00	M",
    (char *)"Rule	Germany	1947	only	-	Jun	29	3:00	1:00	S",
    (char *)"Rule	Germany	1948	only	-	Apr	18	2:00s	1:00	S",
    (char *)"Rule	Germany	1949	only	-	Apr	10	2:00s	1:00	S",
    (char *)"Rule SovietZone	1945	only	-	May	24	2:00	2:00	M # Midsummer",
    (char *)"Rule SovietZone	1945	only	-	Sep	24	3:00	1:00	S",
    (char *)"Rule SovietZone	1945	only	-	Nov	18	2:00s	0	-",
    ...
    (char *)"Zone	Europe/Berlin	0:53:28 -	LMT	1893 Apr",
    (char *)"			1:00	C-Eur	CE%sT	1945 May 24  2:00",
    (char *)"			1:00 SovietZone	CE%sT	1946",
    (char *)"			1:00	Germany	CE%sT	1980",
    (char *)"			1:00	EU	CE%sT"
};
