...
char* PG_Jamaica[] = {(char*)"Rule	US	1918	1919	-	Mar	lastSun	2:00	1:00	D",
                      ...
                      (char*)"Zone	America/Jamaica	-5:07:10 -	LMT	1890        # Kingston",
                      (char*)"			-5:07:10 -	KMT	1912 Feb    # Kingston Mean Time",
                      (char*)"			-5:00	-	EST	1974",
                      (char*)"			-5:00	US	E%sT	1984",
                      (char*)"			-5:00	-	EST",
                      (char*)"Link	America/Jamaica		Jamaica"};
