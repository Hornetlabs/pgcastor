...
char* XK_PG_Australia_Yancowinna[] =
{
    ...
    (char *)"Zone Australia/Broken_Hill 9:25:48 -	LMT	1895 Feb",
    (char *)"			10:00	-	AEST	1896 Aug 23",
    (char *)"			9:00	-	ACST	1899 May",
    (char *)"			9:30	Aus	AC%sT	1971",
    (char *)"			9:30	AN	AC%sT	2000",
    (char *)"			9:30	AS	AC%sT",
    (char *)"Link	Australia/Broken_Hill	Australia/Yancowinna"
};
