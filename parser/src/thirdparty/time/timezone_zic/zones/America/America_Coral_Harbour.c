...
char* XK_PG_America_Coral_Harbour[] =
{
    ...
    (char *)"Zone America/Atikokan	-6:06:28 -	LMT	1895",
    (char *)"			-6:00	Canada	C%sT	1940 Sep 29",
    (char *)"			-6:00	1:00	CDT	1942 Feb  9  2:00s",
    (char *)"			-6:00	Canada	C%sT	1945 Sep 30  2:00",
    (char *)"			-5:00	-	EST",
    (char *)"Link	America/Atikokan	America/Coral_Harbour"
};
