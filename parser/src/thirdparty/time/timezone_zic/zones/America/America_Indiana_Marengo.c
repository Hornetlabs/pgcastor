...
char* XK_PG_America_Indiana_Marengo[] =
{
    ...
    (char *)"Rule	Marengo	1951	only	-	Apr	lastSun	2:00	1:00	D",
    (char *)"Rule	Marengo	1951	only	-	Sep	lastSun	2:00	0	S",
    (char *)"Rule	Marengo	1954	1960	-	Apr	lastSun	2:00	1:00	D",
    (char *)"Rule	Marengo	1954	1960	-	Sep	lastSun	2:00	0	S",
    (char *)"Zone America/Indiana/Marengo -5:45:23 -	LMT	1883 Nov 18 12:14:37",
    (char *)"			-6:00	US	C%sT	1951",
    (char *)"			-6:00	Marengo	C%sT	1961 Apr 30  2:00",
    (char *)"			-5:00	-	EST	1969",
    (char *)"			-5:00	US	E%sT	1974 Jan  6  2:00",
    (char *)"			-6:00	1:00	CDT	1974 Oct 27  2:00",
    (char *)"			-5:00	US	E%sT	1976",
    (char *)"			-5:00	-	EST	2006",
    (char *)"			-5:00	US	E%sT"
};
