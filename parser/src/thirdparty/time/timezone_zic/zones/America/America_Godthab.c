...
char* PG_America_Godthab[] = {(char*)"Rule	EU	1977	1980	-	Apr	Sun>=1	 1:00u	1:00	S",
                              ...
                              (char*)"Zone America/Nuuk	-3:26:56 -	LMT	1916 Jul 28 # Godthåb",
                              (char*)"			-3:00	-	WGT	1980 Apr  6  2:00",
                              (char*)"			-3:00	EU	WG%sT",
                              (char*)"Link	America/Nuuk		America/Godthab"};
