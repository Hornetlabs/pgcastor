...
char* XK_PG_America_Indiana_Vevay[] =
{
    ...
    (char *)"Zone America/Indiana/Vevay -5:40:16 -	LMT	1883 Nov 18 12:19:44",
    (char *)"			-6:00	US	C%sT	1954 Apr 25  2:00",
    (char *)"			-5:00	-	EST	1969",
    (char *)"			-5:00	US	E%sT	1973",
    (char *)"			-5:00	-	EST	2006",
    (char *)"			-5:00	US	E%sT"
};
