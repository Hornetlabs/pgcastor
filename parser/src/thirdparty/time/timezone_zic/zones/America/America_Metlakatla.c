...
char* PG_America_Metlakatla[] = {
    ...
    (char*)"Zone America/Metlakatla	 15:13:42 -	LMT	1867 Oct 19 15:44:55",
    (char*)"			 -8:46:18 -	LMT	1900 Aug 20 12:00",
    (char*)"			 -8:00	-	PST	1942",
    (char*)"			 -8:00	US	P%sT	1946",
    (char*)"			 -8:00	-	PST	1969",
    (char*)"			 -8:00	US	P%sT	1983 Oct 30  2:00",
    (char*)"			 -8:00	-	PST	2015 Nov  1  2:00",
    (char*)"			 -9:00	US	AK%sT	2018 Nov  4  2:00",
    (char*)"			 -8:00	-	PST	2019 Jan 20  2:00",
    (char*)"			 -9:00	US	AK%sT"};
