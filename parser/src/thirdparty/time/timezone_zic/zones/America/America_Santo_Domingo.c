...
char* XK_PG_America_Santo_Domingo[] =
{
    (char *)"Rule	DR	1966	only	-	Oct	30	0:00	1:00	EDT",
    (char *)"Rule	DR	1967	only	-	Feb	28	0:00	0	EST",
    (char *)"Rule	DR	1969	1973	-	Oct	lastSun	0:00	0:30	-0430",
    (char *)"Rule	DR	1970	only	-	Feb	21	0:00	0	EST",
    (char *)"Rule	DR	1971	only	-	Jan	20	0:00	0	EST",
    (char *)"Rule	DR	1972	1974	-	Jan	21	0:00	0	EST",
    ...
    (char *)"Zone America/Santo_Domingo -4:39:36 -	LMT	1890",
    (char *)"			-4:40	-	SDMT	1933 Apr  1 12:00 # S. Dom. MT",
    (char *)"			-5:00	DR	GMT	1974 Oct 27",
    (char *)"			-4:00	-	AST	2000 Oct 29  2:00",
    (char *)"			-5:00	US	E%sT	2000 Dec  3  1:00",
    (char *)"			-4:00	-	AST"
};
