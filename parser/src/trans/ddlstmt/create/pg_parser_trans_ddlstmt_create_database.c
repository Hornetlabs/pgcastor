...
pg_parser_translog_ddlstmt* pg_parser_DDL_create_database(pg_parser_translog_systb2ddl*        pg_parser_ddl,
                                                          ...
                                                          int32_t*                             pg_parser_errno)
{
    ...
    pg_parser_log_errlog(pg_parser_ddl->m_debugLevel, "DEBUG, DDL PARSER: capture create database(ignore) end \n");
