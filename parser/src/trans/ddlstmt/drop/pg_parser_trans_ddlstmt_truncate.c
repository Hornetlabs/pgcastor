...
xk_pg_parser_translog_ddlstmt* xk_pg_parser_DDL_truncate(xk_pg_parser_translog_systb2ddl *xk_pg_parser_ddl,
...
{                           
    ...
    //xk_pg_parser_translog_ddlstmt_drop_base *truncate = NULL;
    ...
    //result->m_base.m_ddlinfo = XK_PG_PARSER_DDLINFO_TRUNCATE;
