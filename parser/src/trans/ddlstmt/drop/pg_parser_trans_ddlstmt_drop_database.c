...
#define DDL_DROP_DATABASE_MCXT NULL

pg_parser_translog_ddlstmt* pg_parser_DDL_drop_database(pg_parser_translog_systb2ddl*        pg_parser_ddl,
                                                        ...
                                                        int32_t*                             pg_parser_errno)
{
    ...
    pg_parser_log_errlog(pg_parser_ddl->m_debugLevel, "DEBUG, DDL PARSER: capture drop database(ignore) end \n");
